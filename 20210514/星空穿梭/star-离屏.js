...
var minSpeed = 0.001;//最小速度
var maxSpeed = 0.08;//最大速度
var starSize = 1;//星星初始半径
var starSizeMax =2.5;//星星最大半径
var opacityMin = 0.1;//星星最小透明度，由1逐渐降低
var opacityMax = 0.9;//星星最大透明度
var maxStarCount = 1000;//最多星星数量
...
offsetCanvas.width = canvas.width-1;
offsetCanvas.height = canvas.height-1;
...
function drawStars(){
    ...
    for(var i=0;i<stars.length;i++){
        ...
        offsetctx.fillStyle =`rgba(255,255,255,${star.opacity})`;
        offsetctx.arc(x,y,star.size,0,Math.PI*2); 
        offsetctx.fill();
    }
